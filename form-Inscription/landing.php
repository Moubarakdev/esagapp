...
<html lang="en">
  ...
  <body>
        <div class="container">
            <div class="col-md-12">
                ...
                <div class="text-center">
                        <h1 class="p-5">Bonjour ! <?php echo $_SESSION['user_name']; ?></h1>
                        <hr />
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Changer mon mot de passe</h5>
                            ...
                            <div class="modal-body">
                                <form action="/esagapp/form-inscription/layouts/change_password.php" method="POST">
    ...
    <script src="../scripts/cdnjs.cloudflare.js"></script>
    <script src="../scripts/bootstrap1.js"></script>
